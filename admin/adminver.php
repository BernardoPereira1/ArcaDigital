        ...
        function uploadfiles() {
            ...
            if (move_uploaded_file($_FILES['uploadedfile']['tmp_name'], $target_path)) {
                ...
                for ($i = 2; $i < $num + 2; $i++) {
                    ...
                    echo "<a href='http://localhost:8080/PastasUtilizadores/$files[$i]'>$files[$i]</a><br/>";
                }
            } else {
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i><?php echo "<a style='color:white; text-decoration: none' href='deletefilesadmin.php?path=$path&file=$file&user=$user'> Apagar</a>" ?></button>
                            </td>
                        </tr>
                    </tbody>
                </table>
