                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i><?php echo "<a style='color:white; text-decoration: none' href='deletefile.php?item=$path/$file'> Apagar</a>" ?></button>
                            </td>
                        </tr>
                    </tbody>
                </table>
