...
<script>
    function uploadfiles() {
        <?php
        $user = $_SESSION['user'];
        $target_path = "../PastasUtilizadores/pastapublica/";
        $path = "../PastasUtilizadores/pastapublica/";
...
<body>
    ...
    <br>
    <form onsubmit="uploadfiles()" id="uploadfile" enctype="multipart/form-data" action="public.php" method="POST">
